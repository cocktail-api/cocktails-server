...
public interface SearchApi {
    ...
    @ApiOperation(value = "Search for cocktails and ingredients", nickname = "unifiedSearch", notes = "", response = SearchResult.class, responseContainer = "List", tags={ "ingredients","cocktails", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "All search results", response = SearchResult.class, responseContainer = "List") })
